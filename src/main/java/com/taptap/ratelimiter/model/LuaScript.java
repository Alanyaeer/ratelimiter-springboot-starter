...
public final class LuaScript {
    ...
    private static final String slideWindowRateLimiterScript;
    ...
    static {
        ...
        slideWindowRateLimiterScript = getRateLimiterScript("META-INF/slideTimeWindow-rateLimit.lua");
    }
    ...
    public static String getSlideWindowRateLimiterScript() {
        return slideWindowRateLimiterScript;
    }
